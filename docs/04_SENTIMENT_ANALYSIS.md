...
- **Subjectivity Score (0.0 to 1.0):** Measuring how much of the review is "opinion" vs. "fact." Fake reviews tend to be highly subjective but contain very little factual detail.
...
- **Sentiment Inconsistency:** One of the strongest flags for a fake review was a high numerical rating (5 stars) paired with a low textual sentiment score.
